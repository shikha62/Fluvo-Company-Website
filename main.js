...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const pillarServices = [
    {
      number: '01', category: 'BUILD DIGITAL EXPERIENCES', title: 'WEB DEVELOPMENT & DIGITAL EXPERIENCE',
      ...
      image: '/assets/services/web-development.png', imageAlt: 'Web development and digital experience illustration'
    },
    {
      number: '02', category: 'CREATE CONNECTED APPS', title: 'APP DEVELOPMENT & MOBILE SOLUTIONS',
      ...
      image: '/assets/services/app-development.png', imageAlt: 'App development and mobile solutions illustration'
    },
    {
      number: '03', category: 'GROW ORGANICALLY', title: 'ORGANIC GROWTH & SEARCH PERFORMANCE',
      ...
      image: '/assets/services/organic-growth.png', imageAlt: 'Organic growth and search performance illustration'
    },
    {
      number: '04', category: 'BUILD WITH INTELLIGENCE', title: 'AI-DRIVEN SYSTEMS & AUTOMATION',
      ...
      image: '/assets/services/ai-automation.png', imageAlt: 'AI-driven systems and automation illustration'
    }
  ];
  ...
  if (pillarRows) {
    pillarRows.innerHTML = pillarServices.map((service, index) => `
      <article class="pillar-row${index % 2 ? ' pillar-row--reverse' : ''}" tabindex="0" role="button" aria-label="${service.title} — ${service.category}" data-pillar-id="${index + 1}">
        <div class="pillar-media"><img src="${service.image}" alt="${service.imageAlt}" loading="lazy"></div>
        <div class="pillar-content"><span class="pillar-number">${service.number}</span><span class="pillar-category">${service.category}</span><h3 class="pillar-title">${service.title}</h3><p class="pillar-description">${service.description}</p></div>
      </article>
    `).join('');
  }
  ...
  Object.assign(capabilityData, {
    1: { id: 1, badge: '01', category: 'WEB DEVELOPMENT & DIGITAL EXPERIENCE', title: 'BUILD DIGITAL EXPERIENCES', tagline: 'ENGINEERED FOR FAST, SCALABLE & HIGH-CONVERTING DIGITAL EXPERIENCES', overview: 'We design and develop fast, responsive websites and digital platforms using modern frontend, backend and cloud technologies.', highlights: ['Frontend Engineering', 'Backend & APIs', 'Performance Engineering', 'Technical SEO'], deliverables: [{ title: 'Frontend Engineering', desc: 'React, Next.js, responsive UI and component-based architecture.' }, { title: 'Backend & APIs', desc: 'REST APIs, authentication, databases and scalable server-side systems.' }, { title: 'Performance Engineering', desc: 'Core Web Vitals, image optimization, caching and fast page delivery.' }, { title: 'Technical SEO', desc: 'Semantic HTML, structured data, crawlability and search-ready architecture.' }], tools: ['React', 'Next.js', 'Node.js', 'REST APIs', 'PostgreSQL', 'Cloudflare', 'Git'], benchmarks: [{ val: 'Fast Load Times', label: 'Website performance', sub: 'Example performance framework' }, { val: 'Responsive Across Devices', label: 'Interface quality', sub: 'Example performance framework' }, { val: 'Scalable Architecture', label: 'System foundation', sub: 'Example performance framework' }, { val: 'Search-Ready Websites', label: 'Technical SEO', sub: 'Example performance framework' }], visualization: { title: 'Website Performance', note: 'Example performance framework', type: 'bars', items: ['Performance', 'Accessibility', 'SEO', 'Best Practices'] }, roadmap: [{ badge: '01 · PLAN', title: 'Map the experience', desc: 'Align content, journeys and technical requirements around the business goal.' }, { badge: '02 · BUILD', title: 'Develop the system', desc: 'Build responsive interfaces, APIs and secure foundations with reusable components.' }, { badge: '03 · OPTIMIZE', title: 'Improve delivery', desc: 'Measure Core Web Vitals, refine technical SEO and strengthen release quality.' }] },
    2: { id: 2, badge: '02', category: 'APP DEVELOPMENT & MOBILE SOLUTIONS', title: 'CREATE CONNECTED APPS', tagline: 'BUILT FOR CONNECTED, FAST & SCALABLE MOBILE EXPERIENCES', overview: 'We build mobile applications that combine intuitive UX, reliable backend systems and scalable APIs for real-world business use.', highlights: ['Cross-Platform Development', 'API & Backend Integration', 'App Performance', 'Deployment & Analytics'], deliverables: [{ title: 'Cross-Platform Development', desc: 'Flutter and modern mobile frameworks for Android and iOS.' }, { title: 'API & Backend Integration', desc: 'Secure REST APIs, authentication, databases and third-party integrations.' }, { title: 'App Performance', desc: 'Optimized rendering, efficient API calls, caching and lightweight interfaces.' }, { title: 'Deployment & Analytics', desc: 'App Store and Play Store deployment, crash monitoring and usage analytics.' }], tools: ['Flutter', 'Dart', 'REST APIs', 'Firebase', 'PostgreSQL', 'Node.js'], benchmarks: [{ val: 'Cross-Platform Apps', label: 'Product delivery', sub: 'Illustrative mobile product framework' }, { val: 'API-Connected Products', label: 'System connectivity', sub: 'Illustrative mobile product framework' }, { val: 'Reliable Performance', label: 'App quality', sub: 'Illustrative mobile product framework' }, { val: 'Scalable Architecture', label: 'Growth foundation', sub: 'Illustrative mobile product framework' }], visualization: { title: 'Mobile Experience Framework', note: 'Illustrative mobile product framework', type: 'bars', items: ['Performance', 'UX', 'Reliability', 'Scalability'] }, roadmap: [{ badge: '01 · DEFINE', title: 'Shape the product', desc: 'Clarify user journeys, platform needs, data flows and release priorities.' }, { badge: '02 · CONNECT', title: 'Build the system', desc: 'Combine mobile UI, secure APIs, authentication and database connectivity.' }, { badge: '03 · RELEASE', title: 'Monitor and improve', desc: 'Prepare store releases, track crashes and use product analytics to guide iteration.' }] },
    3: { id: 3, badge: '03', category: 'ORGANIC GROWTH & SEARCH PERFORMANCE', title: 'GROW ORGANICALLY', tagline: 'SEARCH STRATEGY, TECHNICAL SEO & CONTENT PERFORMANCE', overview: 'We improve how your website is discovered, understood and ranked through technical SEO, content strategy and search performance optimization.', highlights: ['Technical SEO', 'Keyword Strategy', 'Content Optimization', 'Search Performance'], deliverables: [{ title: 'Technical SEO', desc: 'Crawlability, indexing, site architecture, Core Web Vitals and structured data.' }, { title: 'Keyword Strategy', desc: 'Search intent, keyword mapping, topic clusters and competitor analysis.' }, { title: 'Content Optimization', desc: 'Helpful content, semantic relevance, internal linking and on-page optimization.' }, { title: 'Search Performance', desc: 'Organic traffic, rankings, impressions, CTR and conversion tracking.' }], tools: ['Technical SEO', 'Search Console', 'Schema Markup', 'GA4', 'Core Web Vitals', 'Content Strategy'], benchmarks: [{ val: 'Better Search Visibility', label: 'Discovery', sub: 'Search performance outcome' }, { val: 'Stronger Technical Foundation', label: 'Crawl and index', sub: 'Search performance outcome' }, { val: 'Qualified Organic Traffic', label: 'Intent-led reach', sub: 'Search performance outcome' }, { val: 'Search-Driven Conversions', label: 'Business action', sub: 'Search performance outcome' }], visualization: { title: 'Organic Search Growth', note: 'Illustrative growth model', type: 'line', items: ['Month 1', 'Month 2', 'Month 3', 'Month 4', 'Month 5', 'Month 6'] }, roadmap: [{ badge: '01 · DISCOVER', title: 'Map search demand', desc: 'Connect audience needs to search intent, keywords and topic opportunities.' }, { badge: '02 · OPTIMIZE', title: 'Strengthen the foundation', desc: 'Improve crawlability, page structure, content relevance and internal linking.' }, { badge: '03 · MEASURE', title: 'Track search performance', desc: 'Review impressions, CTR, rankings and conversions to guide the next cycle.' }] },
    4: { id: 4, badge: '04', category: 'AI-DRIVEN SYSTEMS & AUTOMATION', title: 'BUILD WITH INTELLIGENCE', tagline: 'AI WORKFLOWS, INTELLIGENT AUTOMATION & DATA-DRIVEN SYSTEMS', overview: 'We connect AI, APIs and automation workflows to reduce repetitive work, improve decision-making and create faster business processes.', highlights: ['AI Integration', 'Workflow Automation', 'Data & API Systems', 'Intelligent Analytics'], deliverables: [{ title: 'AI Integration', desc: 'LLM APIs, AI assistants, document processing and intelligent search.' }, { title: 'Workflow Automation', desc: 'Automated lead routing, notifications, approvals and repetitive business tasks.' }, { title: 'Data & API Systems', desc: 'Connect CRMs, databases, SaaS platforms and internal systems through APIs.' }, { title: 'Intelligent Analytics', desc: 'Dashboards, reporting pipelines and AI-assisted insights for faster decisions.' }], tools: ['LLM APIs', 'Python', 'REST APIs', 'Webhooks', 'n8n', 'Databases', 'Cloud Platforms'], benchmarks: [{ val: 'Less Manual Work', label: 'Efficiency', sub: 'Automation outcome' }, { val: 'Faster Workflows', label: 'Process speed', sub: 'Automation outcome' }, { val: 'Connected Systems', label: 'Integration', sub: 'Automation outcome' }, { val: 'Actionable Insights', label: 'Decision support', sub: 'Automation outcome' }], visualization: { title: 'Automation Workflow', note: 'Illustrative process model', type: 'flow', items: ['Input', 'Data', 'AI / Rules', 'Automation', 'Action', 'Insight'] }, roadmap: [{ badge: '01 · CONNECT', title: 'Map the systems', desc: 'Identify inputs, data sources, business rules and the people involved in each process.' }, { badge: '02 · AUTOMATE', title: 'Build the workflow', desc: 'Connect APIs, AI services and notifications around clear approval and action paths.' }, { badge: '03 · LEARN', title: 'Improve decisions', desc: 'Monitor workflow signals and turn structured data into useful operational insight.' }] }
  });
  ...
  const pillarBackgroundImages = { 1: '/assets/capability-pillar-01.png', 2: '/assets/capability-pillar-02.png', 3: '/assets/capability-pillar-03.png', 4: '/assets/capability-pillar-04.png' };
  ...
  function renderCapability(id) {
    ...
    if (pillarBackgroundImage) pillarBackgroundImage.src = pillarBackgroundImages[id] || '/assets/capability-pillar-background.png';
    ...
    if (pmBenchmarks) {
      ...
      if (visualization.type === 'bars') visualizationMarkup = `<div class="pm-visualization pm-bars-visualization"><div class="pm-visualization-heading"><span>${visualization.title}</span><small>${visualization.note}</small></div>${visualization.items.map((item, index) => `<div class="pm-bar-row"><span>${item}</span><i><b style="width:${[88, 72, 82, 66][index]}%"></b></i></div>`).join('')}</div>`;
      else if (visualization.type === 'line') visualizationMarkup = `<div class="pm-visualization pm-line-visualization"><div class="pm-visualization-heading"><span>${visualization.title}</span><small>${visualization.note}</small></div><svg viewBox="0 0 640 150" role="img" aria-label="Illustrative organic search growth trend"><path class="pm-chart-axis" d="M12 126H628M12 18V126"/><path class="pm-chart-line" d="M18 116 C90 112 112 106 172 106 S246 88 286 92 S358 70 404 74 S492 44 548 50 S590 32 622 26"/><circle class="pm-chart-dot" cx="622" cy="26" r="5"/></svg><div class="pm-chart-labels">${visualization.items.map(item => `<span>${item}</span>`).join('')}</div></div>`;
      else visualizationMarkup = `<div class="pm-visualization pm-flow-visualization"><div class="pm-visualization-heading"><span>${visualization.title}</span><small>${visualization.note}</small></div><div class="pm-flow-list">${visualization.items.map((item, index) => `<span>${item}</span>${index < visualization.items.length - 1 ? '<b>→</b>' : ''}`).join('')}</div></div>`;
